...
export class QuestionsProvider {
     private questions: Question[] = [
      ...
      new Question (2, "Adrien Rabiot a passé un an au FC Séville", false, 2, "sports", "Il n'a jamais joué pour un club espagnol", "Il n'a jamais joué pour un club espagnol"),
